 ...
 */
final class Version20200413152805 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD enable TINYINT(1) DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    }
